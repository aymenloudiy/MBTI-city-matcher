  ...
  return (
    <section className="flex flex-col md:flex-row w-full bg-[#2b0d0d] px-6 md:px-16 mt-6 md:mt-12 py-12 rounded-2xl shadow-lg">
      <div className="flex flex-col justify-center md:w-2/3 gap-2 md:gap-4 text-white text-center md:text-left">
        ...
        <p className="text-sm md:text-m font-mono mt-2 md:mt-4 leading-relaxed px-4 text-center">
          Discover which Canadian city matches your MBTI.
        </p>
        <p className="text-sm md:text-m font-mono leading-relaxed px-4 text-center">
      ...
      <div className="flex flex-col justify-center items-center md:items-start gap-3 md:gap-6 w-full md:w-1/3 mt-6 md:mt-0">
        <a
          ...
          className="w-full text-sm md:text-xl text-center font-medium font-[geo] text-white border-2 border-white py-3 md:py-4 px-6 rounded-xl hover:bg-white hover:text-[#003366] transition-colors duration-200"
        >
          What is MBTI?
        </a>
        <NavLink
          to="/test"
          className="w-full text-sm md:text-xl text-center font-[geo] bg-[#C62828] text-white font-bold py-3 md:py-4 px-6 rounded-xl shadow-lg hover:bg-[#a31d1d] transition-colors duration-200"
        >
          Start Test
        </NavLink>
      </div>
